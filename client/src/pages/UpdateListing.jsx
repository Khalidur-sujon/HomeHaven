...
const UpdateListing = () => {
	...
	//logic is , when this componet first time mounted it will fetch all of the data of this time
	useEffect(() => {
		const fetchListing = async () => {
			const listingItemId = params.listingId;
			const res = await fetch(`/api/listing/get/${listingItemId}`);
